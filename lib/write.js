...
function writeFile (archive, name, data, opts, cb) {
  ...
  return maybe(cb, co(function*() {
    ...
    var existingEntry
    try { existingEntry = yield stat(archive, name) } catch (e) {}
    ...
    if (parentName !== '/' && parentName !== '.') {
      var parentEntry
      try { parentEntry = yield stat(archive, parentName) } catch (e) {}
...
function rename (archive, oldName, newName, cb) {
  return maybe(cb, co(function * () {
    // ensure the target location is writable
    var existingEntry
    try { existingEntry = yield stat(archive, newName) } catch (e) {}
